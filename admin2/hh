<div class="modal fade" id="edit_<?php echo $etud->NumInscription; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="etudiant_edit.php">
                        ...
                        <div class="row ">
                            ...
                            <div class="col">
                                <div class="mb-3"><label class="col-form-label" style="position:relative; top:7px;">Num
                                    ...
                                    <input type="text" class="form-control" name="NumInscription"
                                        value="<?php echo $etud->NumInscription; ?>" readonly>
                                </div>
                            </div>
                            <div class="col">
                                <div class="mb-3">
