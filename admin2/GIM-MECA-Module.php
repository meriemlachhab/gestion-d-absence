...
if(isset($_POST['submit'])){
    ...
    $Module = $Modules->addChild('Module');
            ...
            $Module->addChild('CodeFiliere', "F12");
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           ?>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default"
                                                                ...
                                                                Annuler</button>
                                                            <a href="GIM-MECA-Module-delete.php?CodeModule=<?php echo $etud->CodeModule ?>"
                                            ...
                                            <?php include('GIM-module-edit.php'); ?>
                                        </tr>
                                        <?php } }?>
                                    </tbody>
                                </table>
