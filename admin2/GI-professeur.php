...
if(isset($_POST['submit'])){
    ...
    $Enseignant = $Enseignants->addChild('Enseignant');
            ...
            $Enseignant->addChild('CodeDepartement', "D03");
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="activate.php?NumSomme=<?php echo $etud->NumSomme; ?>" 
                                            ...
                                            <td> <a href="#edit_<?php echo $etud->NumSomme; ?>" data-bs-toggle="modal"
                                                ...
                                                <a href="#delete_<?php echo $etud->NumSomme; ?>" data-bs-toggle="modal"
                                                    role="button"> <i class="fa fa-trash" aria-hidden="true"
                                                        style="color:red;"></i></a>
                                            </td>
                                            <?php include('prof_edit_model.php'); ?>

                                            <?php include('GI-prof_edit_delete_model.php'); ?>
                                        </tr>
                                        <?php }} ?>
                                    </tbody>
                                </table>
