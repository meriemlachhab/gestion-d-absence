...
if(isset($_POST['submit'])){
    ...
    $Module = $Modules->addChild('Module');
            ...
            $Module->addChild('CodeFiliere', "F03");
    
    
    file_put_contents('../data/absence.xml', $file->asXML());
        header('location:GI-ISIR-Module.php');
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           ?>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default"
                                                                ...
                                                                Annuler</button>
                                                            <a href="GI-ISIR-Module-delete.php?CodeModule=<?php echo $etud->CodeModule ?>"
                                            ...
                                            <?php include('module_update_model.php'); ?>
