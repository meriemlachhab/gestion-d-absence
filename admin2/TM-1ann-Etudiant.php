...
if(isset($_POST['submit'])){
    ...
    $Etudiant = $Etudiants->addChild('Etudiant');
            ...
            $Etudiant->addChild('idniveau', "N01");
            $Etudiant->addChild('CodeFiliere', "F04");
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-default"
                                                                ...
                                                                Annuler</button>
                                                            <a href="TM-GCF-Etud-delete.php?NumInscription=<?php echo $etud->NumInscription; ?>"
